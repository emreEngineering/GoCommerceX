...
const file_proto_product_proto_rawDesc = "" +
	...
	"\n" +
	"GetProduct\x12\x1d.product.v1.GetProductRequest\x1a\x1e.product.v1.GetProductResponse\x12Z\n" +
	"\x0fGetProductBySKU\x12\".product.v1.GetProductBySKURequest\x1a#.product.v1.GetProductBySKUResponse\x12T\n" +
	"\rUpdateProduct\x12 .product.v1.UpdateProductRequest\x1a!.product.v1.UpdateProductResponse\x12T\n" +
	"\rDeleteProduct\x12 .product.v1.DeleteProductRequest\x1a!.product.v1.DeleteProductResponseB(Z&GoCommerceX/proto/product/v1;productv1b\x06proto3"
...
var file_proto_product_proto_goTypes = []any{
	...
	(*GetProductBySKURequest)(nil),  // 5: product.v1.GetProductBySKURequest
	(*GetProductBySKUResponse)(nil), // 6: product.v1.GetProductBySKUResponse
...
var file_proto_product_proto_depIdxs = []int32{
	...
	0,  // 2: product.v1.GetProductBySKUResponse.product:type_name -> product.v1.Product
	...
	5,  // 6: product.v1.ProductService.GetProductBySKU:input_type -> product.v1.GetProductBySKURequest
	...
	6,  // 11: product.v1.ProductService.GetProductBySKU:output_type -> product.v1.GetProductBySKUResponse
